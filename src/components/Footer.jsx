...
const Footer = () => {
  const phoneNumber = "+8801762609348";
  const emailAddress = "abdullahalanan30@gmail.com";
  ...
  const copyToClipboard = (text, message) => {
    ...
    toast.success(message, {
      ...
      style: {
        ...
        border: "1px solid #29ef46ff", // orange-500
  ...
  return (
    <>
      ...
      <motion.footer
        ...
        className="bg-gradient-to-r from-[#60a5fa] via-[#3b82f6] to-[#60a5fa] text-black py-4 px-6 text-center rounded-t-xl shadow-lg relative overflow-hidden"
      >
        {/* Animated top border */}
        ...
        <div className="relative z-10">
          <div className="flex flex-col sm:flex-row justify-between items-center w-full gap-3 sm:gap-6">
            ...
            <p className="text-xs sm:text-sm font-light">
              ...
              <span className="text-black font-semibold">Anan</span> — All rights reserved.
            </p>
